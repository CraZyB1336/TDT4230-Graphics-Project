...
void subsurfaceStage(SceneNode* rootNode, Gloom::Shader &diffuseShader, Gloom::Shader &horizontalShader, Gloom::Shader &verticalShader, LightSource* lightSources, glm::mat4 &VP, glm::vec3 &cameraPosition, unsigned int skyboxFBO);
